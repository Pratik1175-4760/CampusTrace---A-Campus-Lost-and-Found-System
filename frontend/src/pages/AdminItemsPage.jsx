...
import { Search, CheckSquare, Filter, Phone, Mail, User, Eye } from 'lucide-react'
    ...
    <div className="p-6 fade-in">
      <div className="mb-6 flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-0.5">{total} total items in system</p>
        </div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="pl-9 pr-4 py-2 border border-slate-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-900 w-56"
          />
        </div>
      </div>
...
function AdminItemDetail({ item, onVerify, onClose }) {
  ...
  return (
    <div className="space-y-5">
      <img src={item.imageUrl} alt={item.category} className="w-full h-52 object-contain rounded-xl bg-slate-100 border border-slate-200" />
